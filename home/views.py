...
def gen_resume(request):
    if request.method == 'POST':
        ...
        resume=Resume(name = name, about = about, age = age, email = email, phone = phone, skill1 = skill1, skill2 = skill2,
        skill3 = skill3, skill4 = skill4, skill5 =skill5, degree1 = degree1, college1 = college1, year1 = year1,
        degree2 = degree2, college2 = college2, year2 = year2, college3 = college3, year3 = year3, degree3 = degree3, 
        lang1 = lang1,lang2 = lang2,lang3 = lang3,project1= project1,durat1 = durat1,desc1 = desc1, project2 = project2,
        durat2 = durat2,desc2 = desc2,company1 = company1,post1 = post1,duration1 = duration1,lin11 = lin11,
        company2 = company2,post2 = post2,duration2 = duration2,lin21 = lin21, ach1 = ach1,ach2 = ach2,ach3 = ach3)
        resume.save()
